      ...
      <div className={styles.divContent}>
        ...
        <p>
          <span style={{ color: "rgb(68, 68, 68)" }}>
            A sua privacidade é importante para nós. É política do Eatspot
            respeitar a sua privacidade em relação a qualquer informação sua que
            possamos coletar no site <a href="https://eatspot.com/">Eatspot</a>,
        ...
        <p>
          <span style={{ color: "rgb(68, 68, 68)" }}>
            ...
            informação que o Eatspot oferece no site e com caráter enunciativo,
            mas não limitativo:
          </span>
        </p>
        <ul>
          ...
          <li>
            <span style={{ color: "rgb(68, 68, 68)" }}>
              ...
              (softwares) do Eatspot, de seus fornecedores ou terceiros, para
        ...
        <p>
          <span style={{ color: "rgb(68, 68, 68)" }}>
            Esta política é efetiva a partir de&nbsp;4 December 2023 01:21
          </span>
        </p>
      </div>
    </Container>
